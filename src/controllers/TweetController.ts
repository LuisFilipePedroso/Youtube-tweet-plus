...
class TweetController {
  ...
  @Subscription(returns =>  Tweet,{ topics: "TWEET" })
  normalSubscription(@Root() tweet: ITweetDocument): ITweetDocument {
    return tweet;
  }
  ...
  async create(
    ...
    await pubSub.publish('TWEET', tweet);
